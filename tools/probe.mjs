...
const SOLO = new Set([
  ...
  'beastcast',
  // Rides a ground beast, teleports it thirty units up and reads where the
  // dismount put the hero. It drives state (grant, ride, teleport) and its
  // clock is __dbgAdvance, which steps nothing in a background tab.
  'dismount',
]);
