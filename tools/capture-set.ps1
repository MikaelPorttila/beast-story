...
# Vistas + hero + HUD
bun tools/screenshot.mjs shots/vista.png "photo=1&hud=0&cam=14,10,20&look=0,6,-6" 1600 900 9000
bun tools/screenshot.mjs shots/vista-low.png "photo=1&hud=0&cam=-8,3,12&look=4,9,-14" 1600 900 9000
bun tools/screenshot.mjs shots/hero-front.png "photo=1&hud=0&cam=0.9,1.6,3.2&look=0,1.1,0" 1200 900 7000
bun tools/screenshot.mjs shots/gameplay-hud.png "play=1" 1600 900 9000
