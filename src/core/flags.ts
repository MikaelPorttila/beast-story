...
export const flags = {
  ...
  /**
   * `debug=1` — the developer's game: F2 overlay open at boot, F3 reachable and on the F1 sheet,
   * a new game bonded to the starter. A player's new game has no beast and no F3. Defaults OFF.
   */
  debug: p.get("debug") === "1",
  /**
