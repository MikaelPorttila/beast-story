...
export const en = {
  ...
  "pause.save": "Save",
  "pause.saved": "Progress saved",
  "pause.saveFailed": "Progress could not be saved",
  "pause.hint": "Aim with the pointer or left stick · click or A to choose · Esc or B to close",
  /**
