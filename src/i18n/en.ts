...
export const en = {
  ...
  'item.swordIron.desc': 'Plain, balanced and honest. Everyone in Embervale learns on one of these.',
  ...
  'item.scytheReaper.desc': 'Farm tool by shape only. Something has been sharpening it for a long time.',
  ...
  'item.bp.desc': 'A pattern waiting for Cubloons. Fill it with attributes and the forge makes it real.',
  ...
  'spawn.enemies.note': 'into the world, 8 m ahead',
  'spawn.structures': 'Structures',
  'spawn.structures.note': 'built on the ground, 8 m ahead',
